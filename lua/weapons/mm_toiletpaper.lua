SWEP.SelectIcon = "vgui/entities/mm_tp"
SWEP.Cost = 0
SWEP.Points = 5
...
function SWEP:Initialize()
    ...
    self.Owner:SetNWFloat("mm_tp_recharge", 0)
end
...
function SWEP:Think()
	...
	if self.Weapon:Clip1() < 1 then
		...
		return
	elseif self.Owner:GetNWFloat("mm_tp_recharge") != 0 then
	...
	if self:GetNextPrimaryFire() < CurTime() && self.Owner:KeyPressed(IN_ATTACK) && self:GetPrimed() == true then
        ...
        if SERVER then
            ...
            local grenade = ents.Create("ent_tp")
        ...
        self.Owner:SetNWFloat("mm_tp_recharge", CurTime()+20)
